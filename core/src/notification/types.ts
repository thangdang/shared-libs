...
export interface NotificationConfig {
  ...
  /** Telegram config (for alerts/admin notifications) */
  telegram?: {
    botToken?: string;
    chatId?: string;
  };
...
export type NotificationSeverity = 'critical' | 'error' | 'warning' | 'info' | 'success';
...
export interface NotificationProvider {
  ...
  send(payload: NotificationPayload & { severity?: NotificationSeverity }): Promise<SendResult>;
}
